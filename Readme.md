# 📈 End-to-End Stock Analytics Pipeline (ETL/ELT)
...
```text
├── dags/
│   ├── dag_yfinance_etl.py    # Ingestion DAG
│   ├── dag_dbt_elt.py         # Transformation DAG (dbt wrapper)
│   └── dag_ml_forecast.py     # Machine Learning DAG
